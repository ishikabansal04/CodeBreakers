...
function displayscore()
{
        ...
        for(var i=0; i<len;i++)
        {
            ...
            var r = table[0].rows;
            console.log(r);
            console.log(r[0].cells[0]);
            console.log(r[0].cells[1]);
            if(session[i]==0)
            { r[0].cells[1].innerHTML= parseInt(r[0].cells[1].innerHTML) + 1;}
            else { r[0].cells[0].innerHTML= parseInt(r[0].cells[0].innerHTML) +1 };
...
function delete_scores()
{
    ...
    r[0].cells[1].innerHTML=0;

    r[0].cells[0].innerHTML=0;
